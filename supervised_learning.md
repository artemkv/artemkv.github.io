...
- For Poisson distribution, we construct Poisson regression (https://en.wikipedia.org/wiki/Poisson_regression), turns out, also uses the least squares as an error function
